...
export const ConfirmDialog: React.FC<ConfirmDialogProps> = ({ onConfirm, onCancel, message }) => {
  return (
    <motion.div
      ...
      className='w-[80%] lg:w-[30%] bg-[var(--color-background)] rounded-xl pb-4 box-border shadow-lg shadow-amber-50 flex flex-col items-center gap-4'>
      <h2 className="border-b-2 w-full bg-[var(--color-surface)] text-center py-2 rounded-xl text-[var(--color-text-heading)]"
